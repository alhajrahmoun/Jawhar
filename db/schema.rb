...
ActiveRecord::Schema[7.0].define(version: 2022_04_17_173257) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["gist_id", "user_id"], name: "index_bookmarks_on_gist_id_and_user_id", unique: true
    t.index ["gist_id"], name: "index_bookmarks_on_gist_id"
  ...
  add_foreign_key "bookmarks", "gists"
